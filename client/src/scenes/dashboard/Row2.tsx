        ...
        return (
            ...
            operationalData[0].monthlyData.map(({ month, operationalExpenses, nonOperationalExpenses }) => {
                return {
                    ...
                    "Non Operartional Expenses": nonOperationalExpenses,
                };
            }
            )
        )
                ...
                <ResponsiveContainer width="100%" height="100%">
                    ...
                    >
                        ...
                        <Line
                            yAxisId="left"
                            type="monotone"
                            dataKey="Non Operartional Expenses"
            ...
            <DashboardBox gridArea="e">
                ...
                <FlexBetween mt="0.25rem" gap="1.5rem" pr="1rem">
                    ...
                    <Box ml="-0.7rem" flexBasis="40%" textAlign={"center"}>
                        ...
                        <Typography variant='h3' m="0.3re," color={palette.primary[300]}>83</Typography>
            ...
            <DashboardBox gridArea="f">
                ...
                <ResponsiveContainer width="100%" height="100%">
                    ...
                    >
                        ...
                        <Scatter name="Produc Expense Ratio" data={productExpenseData} fill={palette.tertiary[500]} />
                    </ScatterChart>
                </ResponsiveContainer>
            </DashboardBox>
        </>
